 ...
 * Windows).
 */
class TcpCubic25 : public TcpCongestionOps
{
public:
   ...
   * Copy constructor.
   */
  TcpCubic25 (const TcpCubic25& sock);

  /**
   * Default deconstructor.
   */
  virtual ~TcpCubic25 (void);
...
protected:
  uint32_t  /*SequenceNumber32*/       m_recover;      //< Previous highest Tx seqnum for fast recovery
